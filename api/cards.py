...
cards = [
    ...
    Card(SkipEveryone(Colour.YELLOW), Number(Colour.ORANGE, "3")),
    Card(SkipEveryone(Colour.YELLOW), Flip(Colour.TURQUOISE)),
    Card(SkipEveryone(Colour.RED), DrawFive(Colour.ORANGE)),
    Card(SkipEveryone(Colour.RED), Wild()),
    Card(SkipEveryone(Colour.BLUE), Number(Colour.TURQUOISE, "1")),
    Card(SkipEveryone(Colour.BLUE), Number(Colour.PINK, "9")),
    Card(SkipEveryone(Colour.GREEN), Number(Colour.PURPLE, "4")),
    Card(SkipEveryone(Colour.GREEN), Number(Colour.ORANGE, "9")),
